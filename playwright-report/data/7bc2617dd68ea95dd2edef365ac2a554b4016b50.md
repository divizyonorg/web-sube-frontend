...
- Name: kredi-basvurusu.spec.ts >> Kredi Başvurusu >> kredi türü seçimi yapılabiliyor
- Location: tests\kredi-basvurusu.spec.ts:23:7

# Error details

```
Error: 🐛 BUG: Kredi türü seçim alanı bulunamadı
