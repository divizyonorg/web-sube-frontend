...
- Name: kredi-basvurusu.spec.ts >> Kredi Başvurusu >> 1. adım görünür ve devam butonu var
- Location: tests\kredi-basvurusu.spec.ts:16:7

# Error details

```
Error: 🐛 BUG: Kredi başvurusu 1. adım içeriği bulunamadı — HTMX yüklenmemiş olabilir
