...
test.describe('Kredi Danışmanı', () => {
  ...
  test('"Başvuruyu Gönder" boş formda devre dışı', async ({ page }) => {
    ...
    if (!await submitBtn.isDisabled())
      bug('Boş formda "Başvuruyu Gönder" butonu aktif — validasyon çalışmıyor');
  });
