    ...
    public IViewComponentResult Invoke(string activePage = "")
    {
        var model = new SidebarViewModel
        {
            ...
            [
                ...
                new() { Label = "Faturaların",          Href = "/Faturalarin",     Icon = SidebarIcon.Invoices,     IconFile = "receipt",           IsActive = activePage == "Faturaların" },
                new() { Label = "Sözleşmelerin",        Href = "/Sozlesmelerin",   Icon = SidebarIcon.Contracts,    IconFile = "file-check-02",     IsActive = activePage == "Sözleşmelerin" },
